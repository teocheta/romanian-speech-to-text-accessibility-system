...
CSV_PATH = "../data/transcriptions/fine_tuning_data.csv"
MODEL_SAVE_PATH = "../model/model_finetuned.pth"
...
PRETRAINED_MODEL_PATH = "../model/model_combined.pth"
...
print("[INFO] Modelul fine-tuned a fost salvat.")
