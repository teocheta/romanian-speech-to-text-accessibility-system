...
from utils import encode_transcript, decode_prediction, build_vocab, beam_search_decode

# ========== CONFIG ========== #
CSV_PATH = "../data/transcriptions/combined_all_sources.csv"
MODEL_PATH = "../model/model_combined.pth"  # ← modifică în funcție de modelul tău salvat
VOCAB_PATH = "../vocab_combined.json"
RESULTS_PATH = "../results/test_combined_results.csv"
...
model.eval()
print("[INFO] Modelul a fost încărcat.")

# ========== TRANSFORMARE AUDIO (identic cu antrenarea) ========== #
...
print(f"[INFO] WER mediu pe test: {average_wer:.4f}")
