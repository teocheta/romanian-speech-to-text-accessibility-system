...
MODEL_PATH = "../model/model_finetuned.pth"  # ← modelul fine-tuned
VOCAB_PATH = "../vocab_combined.json"
RESULTS_PATH = "../results/test_combined_results_finetuned.csv"
...
model.eval()
print("[INFO] Modelul fine-tuned a fost încărcat.")
